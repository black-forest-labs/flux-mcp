...
- Documentation feedback on the [MCP integration docs](https://docs.bfl.ai/api_integration/mcp_integration).

## What goes elsewhere

| You're hitting... | File it at... |
| --- | --- |
| A bug in the FLUX API itself (wrong output, billing, account) | [docs.bfl.ai](https://docs.bfl.ai) |
| `mcp.bfl.ai` is unreachable or OAuth is broken | Check [status.bfl.ai](https://status.bfl.ai) first |
...
- The README's install snippets are kept in sync with [docs.bfl.ai](https://docs.bfl.ai) — please update both if you're changing install flow.
